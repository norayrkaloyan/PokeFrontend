    ...
    if (attack) {
      let damage = botPlayerDamage - firstPlayerDefense;
       if (damage > 0) {
        ...
        console.log(`1: botPlayerDamage: ${botPlayerDamage} firstPlayerDEFENSE: ${firstPlayerDefense} firstHeath:${firstPlayerHealth} dmage: ${damage}` )
        console.log(`attacke: ${props.botPlayer.base.Attack} SP-Attacke: ${props.botPlayer.base["Sp. Attack"]}, Speed:${props.botPlayer.base.Speed}`)
      } else {
        if(damage >= firstPlayerHealth)  {
          damage = firstPlayerHealth;
        }
        let randomDamage = Math.floor(Math.random() * 10 + 5)
        setFirstPlayerHealth(
          firstPlayerHealth - randomDamage
        );
      ...
      if (damage > 0) {
        ...
        console.log(`0: firstPlayerDamage: ${firstPlayerDamage} botPlayerDEFENSE: ${botPlayerDefense} botHeath:${botPlayerHealth} dmage: ${damage}` )
        console.log(`attacke: ${props.firstPlayer.base.Attack} SP-Attacke: ${props.firstPlayer.base["Sp. Attack"]}, Speed:${props.firstPlayer.base.Speed}`)
      } else {
        if(damage >= botPlayerHealth)  {
          damage = botPlayerHealth;
        }
